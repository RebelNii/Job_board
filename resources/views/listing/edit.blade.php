...
<x-card class=" p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/listing/{{$listing->id}}" enctype="multipart/form-data">
        @csrf<!---This prevent cross site injection-->
        @method('PUT')<!--since it's an update we need to use PUT bt we can change the POST above so lara gives us an atl method-->
        <div class="mb-6">
            <label
                for="company"
